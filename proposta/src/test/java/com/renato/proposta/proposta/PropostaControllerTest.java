package com.renato.proposta.proposta;
...
import com.renato.proposta.analisaProposta.StatusAnaliseCliente;
...
public class PropostaControllerTest {
	...
	@MockBean
	private AnalisaCliente MockCartao;
	...
	public void criaPropostaDeveriaCriarNovaPropostaComSucesso() throws JsonProcessingException, Exception {
		 Mockito.when(MockCartao.consultaAnalise(Mockito.any()))
		 .thenReturn(new AnalisaClienteResponse(StatusAnaliseCliente.SEM_RESTRICAO));
